...
Run the map.py program.   In the first part, the program will read the input
...
visualize the data in the second part which runs automatically.  This
part reads the database and writes tile file (where.js)
